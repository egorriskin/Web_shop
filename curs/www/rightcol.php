    ...
    <ul><?php echo '
        ...
        <li>
            ...
            <ul id="ul_show">
                <?php echo'
                <li>
                    <a href="'.$animal.'.php?animal='.$animal.'&sort=price-asc">
                        От дешевых к дорогим
                    </a>
                </li>
                <li>
                    <a href="'.$animal.'.php?animal='.$animal.'&sort=price-desc">
                        От дорогих к дешевым
                    </a>
                </li>
                <li>
                    <a href="'.$animal.'.php?animal='.$animal.'&sort=brand">
                        От А до Я
                    </a>
                </li>
                <li>
                    <a href="'.$animal.'.php?animal='.$animal.'&sort=popular">
                        Популярное
                    </a>
                </li>
                <li>
                    <a href="'.$animal.'.php?animal='.$animal.'&sort=news">
                        Новинки
                    </a>
                </li>
                ';?>
...
<div id="rightcol">
    ...
    $count = mysql_query("SELECT COUNT(*) FROM table_products WHERE visible = '1' and animal='$animal'",$link);
    ...
    If ($temp[0] > 0)
    {
        ...
        $result= mysql_query("select * from table_products where animal='$animal' ORDER BY $sorting $qury_start_num",$link);
        if(mysql_num_rows($result) >0)
        {
            $row=mysql_fetch_array($result);
            do
    ...
    if ($page != 1){ $pstr_prev = '<li><a id="pstr-prev" href="'.$animal.'.php?animal='.$animal.'&page='.($page - 1).'">&lt;</a></li>';}
    if ($page != $total) $pstr_next = '<li><a id="pstr-next" href="'.$animal.'.php?animal='.$animal.'&page='.($page + 1).'">&gt;</a></li>';



    if($page - 5 > 0) $page5left = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page - 5).'">'.($page - 5).'</a></li>';
    if($page - 4 > 0) $page4left = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page - 4).'">'.($page - 4).'</a></li>';
    if($page - 3 > 0) $page3left = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page - 3).'">'.($page - 3).'</a></li>';
    if($page - 2 > 0) $page2left = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page - 2).'">'.($page - 2).'</a></li>';
    if($page - 1 > 0) $page1left = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page - 1).'">'.($page - 1).'</a></li>';

    if($page + 5 <= $total) $page5right = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page + 5).'">'.($page + 5).'</a></li>';
    if($page + 4 <= $total) $page4right = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page + 4).'">'.($page + 4).'</a></li>';
    if($page + 3 <= $total) $page3right = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page + 3).'">'.($page + 3).'</a></li>';
    if($page + 2 <= $total) $page2right = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page + 2).'">'.($page + 2).'</a></li>';
    if($page + 1 <= $total) $page1right = '<li><a href="'.$animal.'.php?animal='.$animal.'&page='.($page + 1).'">'.($page + 1).'</a></li>';


    if ($page+5 <= $total)
    {
        $strtotal = '<li><p id="nav-point">...</p></li><li><a href="'.$animal.'.php?animal='.$animal.'&page='.$total.'">'.$total.'</a></li>';
    }else
    {
        $strtotal = "";
    }
    ...
    <ul>
    ';
        echo $pstr_prev.$page5left.$page4left.$page3left.$page2left.$page1left."<li><a id='pstr-active' href=''.$animal.'.php?animal='.$animal.'&page=".$page."'>".$page."</a></li>".$page1right.$page2right.$page3right.$page4right.$page5right.$strtotal.$pstr_next;
        echo '
    </ul>
    </div>
    ';
